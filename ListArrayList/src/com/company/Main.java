...
public class Main {
    ...
    public static void modifyItem() {
        ...
        groceries.modifyGroceryItem(itemNo, newItem);
    }
    ...
    public static void removeItem() {
        ...
        String itemNo = scanner.nextLine();
        scanner.nextLine();
        groceries.removeGroceryItem(itemNo);
    ...
    public static void searchForItem() {
        ...
        if (groceries.onFile(searchItem)) {
    ...
    public static void processArrayList() {
        ...
        ArrayList<String> nextArray = new ArrayList<String>(groceries.getGroceryList());
